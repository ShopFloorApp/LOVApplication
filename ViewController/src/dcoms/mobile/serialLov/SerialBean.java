...
public class SerialBean {
    ...
    public void setSerialStatus(String SerialStatus) {
        String oldSerialStatus = this.SerialStatus;
        this.SerialStatus = SerialStatus;
        propertyChangeSupport.firePropertyChange("SerialStatus", oldSerialStatus, SerialStatus);
    }
